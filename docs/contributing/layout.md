...
│   ├── ...             # Implementation of the other kernel::* classes / definitions
...
├── pkg/                # Hold build packages to be published on the [Puppet forge](https://forge.puppetlabs.com/ULHPC/kernel)
